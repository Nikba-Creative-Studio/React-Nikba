...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>React plasează textul, care este scris între <code v-pre>&amp;#60;FancyParagraph&amp;#62;</code> și <code v-pre>&amp;#60;/FancyParagraph&amp;#62;</code>, în <code v-pre>children</code>.
Și puteți accesa valoarea acestui prop în componenta copil prin <code v-pre>props.children</code>.</p>
<p>Mintea curioasă se întreabă: ce se va întâmpla dacă <code v-pre>children</code> este specificat ca <code v-pre>props</code> la componentă, și nu descris în interiorul tagului? Dacă faceți asta, nu se va întâmpla nimic rău, dar <code v-pre>children</code>, descris între tagurile elementului, va avea prioritate față de <code v-pre>children</code>, care este dat ca <code v-pre>props</code>:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>În unele cazuri, <code v-pre>props.children</code> ajută la simplificarea codului și la creșterea lizibilității acestuia. Să ne uităm la un exemplu în care se folosește <code v-pre>notificationText</code> în props-uri pentru a afișa un mesaj de avertizare în componenta <code v-pre>Notification</code>:</p>
...
<span class="token operator">/</span><span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>În acest exemplu nu este nimic rău (cu excepția radiațiilor), dar trebuie să rețineți că componenta așteaptă ca intrarea să fie <code v-pre>notificationText</code>. Acest lucru creează o sarcină cognitivă suplimentară și consumă timp.</p>
<p>În schimb, putem folosi <code v-pre>props.children</code> și face codul mai lizibil:</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// Componenta</span>
<span class="token keyword">const</span> <span class="token function-variable function">Notification</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">props</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">(</span>
    <span class="token operator">&lt;</span>div className<span class="token operator">=</span><span class="token string">"Notification"</span><span class="token operator">></span>
...
<p>Rețineți că în <code v-pre>children</code> ajunge tot ce este situat între tagurile de deschidere și închidere ale elementului.</p>
...
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>În acest exemplu, meniul de pe site este format în componenta <code v-pre>NavBar</code>.
Apoi, cu respectarea structurii HTML, este randat în componenta <code v-pre>DropdownMenu</code> cu ajutorul <code v-pre>props.children</code>.
...
<p>Abilitatea de a folosi <code v-pre>props.children</code> permite crearea unei interfețe de utilizator mai flexibile pentru personalizare.</p>
